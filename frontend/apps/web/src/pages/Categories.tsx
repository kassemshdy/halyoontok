  ...
  return (
    <div className="min-h-screen bg-black px-4 pb-24 pt-12">
      ...
      <div className="mt-6 grid grid-cols-2 gap-3">
        {CATEGORIES.map((cat) => (
          <Link key={cat.value} href={`/categories/${cat.value}`} className={`flex flex-col items-center justify-center rounded-2xl bg-gradient-to-br ${cat.color} p-6 active:scale-95 transition`}>
